...
try {
  ...
  if (!fs.existsSync(cfg)) fs.writeFileSync(cfg, "export default [{ files: ['**/*.js'], ignores: ['node_modules/**'], languageOptions: { ecmaVersion: 2022, sourceType: 'commonjs', globals: { require: 'readonly', module: 'readonly', process: 'readonly', console: 'readonly', __dirname: 'readonly', Buffer: 'readonly', setTimeout: 'readonly', clearTimeout: 'readonly', setInterval: 'readonly', URLSearchParams: 'readonly', URL: 'readonly', fetch: 'readonly', AbortController: 'readonly', exports: 'writable' } }, rules: { 'no-undef': 'error' } }];\n");
